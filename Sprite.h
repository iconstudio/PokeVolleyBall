...
class GameSprite {
public:
	GameSprite(HINSTANCE, const UINT, const UINT = 1, const int = 0, const int = 0, COLORREF = 0);
	GameSprite(const LPCTSTR, const UINT = 1, const int = 0, const int = 0, COLORREF = 0);
	~GameSprite();
