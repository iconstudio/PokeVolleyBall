...
public:
	...
	void draw(HDC surface, const double x, const double y, const UINT index = 0, const double angle = 0.0, const double xscale  = 1.0, const double yscale  = 1.0, const double alpha = 1.0);
